...
return [
    ...
    'recaptcha'             =>'Pastikan bahwa anda adalah manusia',
    'custom' => [
        'g-recaptcha-response' => [
            'required' => 'Pastikan bahwa anda bukan sebuah robot.',
            'captcha' => 'Captcha Bermasalah! Coba lagi nanti atau hubungi admin.',
        ],
    ],
];
