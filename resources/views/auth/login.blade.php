...
<div class="login-box-body">
    <p class="login-box-msg">Kartu Pammase Login</p>
      ...
      <div class="form-group has-feedback">
        ...
        @if ($errors->has('email'))
            <span class="invalid-feedback" role="alert">
                <strong>{{ $errors->first('<email></email>') }}</strong>
            </span>
        @endif
      </div>
      <div class="form-group has-feedback">
    ...
    <div class="row">
        ...
        <div class="col-xs-6">
            <a href="{{ route('register') }}" class="text-center pull-right">Daftar Akun Baru</a>
        </div>
