...
<script type="text/javascript">
    let url = "{!! route('data.index') !!}";
</script>
@push('scriptInput')
    <!-- page script -->
    <script>
        $(function () {
            // $('#kecamatan-kel').on('change', function () {
            //     $('#kelurahan').empty();
            ...
            // $('#kecamatan').on('change', function () {
            //     location.href = '/data/create?kec='+$(this).val() + '&kel=';
            // });

            // $('#kelurahan').on('change', function () {
            //     location.href = '/data/create?kec='+$('#kecamatan').val()+'&kel=' + $(this).val();
            // });
        })
    </script>
@endpush