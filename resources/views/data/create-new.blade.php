                ...
                <div class = "box box-primary">
                    <div class = "box-header with-border">
                        ...
                        <div class = "pull-right box-tools">
                            <a data-toggle = "tooltip" title = "" data-original-title = "Lihat Keluarga"
                               href = "{{ route('data.index') }}" class = "btn btn-primary"
                               tabindex = "10">Keluarga</a>
                            <a data-toggle = "tooltip" title = "" data-original-title = "Lihat Anggota Keluarga"
                               href = "{{ route('anggota.index') }}" class = "btn btn-danger "
                               tabindex = "11">Anggota</a>
                            <a data-toggle = "tooltip" title = "" data-original-title = "Daftar Anggota Keluarga"
                               href = "{{ route('anggota.create') }}" class = "btn btn-success"
